            ...
            <div className="container mx-auto px-4">
              <div className="relative h-20 rounded-b flex justify-center">
                <div className="absolute -bottom-6">
                  {/* Sua foto aqui: */}
                    <img
                      src="https://pps.whatsapp.net/v/t61.24694-24/321242306_219255413886785_3154773531630813061_n.jpg?ccb=11-4&oh=01_AdRQ24sXUuVL_fmzrLhFc0JKaGC8BceppI1rI0YBAIEnbA&oe=653B9165&_nc_sid=000000&_nc_cat=111"
              ...
              <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">                           
                    ...
                    Opa, tudo bueno? Sou o Ryan de Leon, tenho 20 anos e sou estudante na FURG.
                    </p>
                    <br/>
                    {/* Link para seu GitHub aqui: */}
                    <a 
                      href="https://github.com/RyanBLeon28" 
