            ...
            <div className="container mx-auto px-4">
              <div className="relative h-20 rounded-b flex justify-center">
                <div className="absolute -bottom-6">
                  {/* Sua foto aqui: */}
                    <img
                      src="https://i.imgur.com/kDzyQhl.png"
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">                           
                    ...
                    <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                        Eai gurizada, eu sou o Vitor e tenho 20 anos. Sou um cara simples, que curte praticar esportes e jogar videojogos... 
                        Sou apaixonado pelo Sport Clube Internacional, e pela minha namorada. 
                    </p>
                    <br/>
                    {/* Link para seu GitHub aqui: */}
                    <a href="https://github.com/vitorfreitasz" className="font-normal text-yellow-500">
                      <GitHubIcon/>
                    </a>
                  </div>
                </div>
